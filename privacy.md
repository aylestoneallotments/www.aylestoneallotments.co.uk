...
This privacy policy is for this website [{{ site.url | replace: 'http://', '' }}]({{ site.url }}) and provided by {{ site.title }} and governs the privacy of its users who choose to use it.
...
This website and its owners through their social media platform accounts may share web links to relevant web pages. By default some social media platforms shorten lengthy urls [web addresses] (this is an example: http://bit.ly/sd452). 
